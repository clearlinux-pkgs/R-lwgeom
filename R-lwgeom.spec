...
Version  : 0.2.9
Release  : 42
URL      : https://cran.r-project.org/src/contrib/lwgeom_0.2-9.tar.gz
Source0  : https://cran.r-project.org/src/contrib/lwgeom_0.2-9.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664809757
