...
Version  : 0.2.4
Release  : 18
URL      : https://cran.r-project.org/src/contrib/lwgeom_0.2-4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/lwgeom_0.2-4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591375928
